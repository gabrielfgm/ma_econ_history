...
+ Explaining the 'first era of globalization' (arguably)
    ...
    - A focus on international economic topics: trade, finance, currencies
]
...
+ Thinking about drivers of economic integration and disintegration
    ...
    - with substantial shocks and discontent (war, supply chains, financial crisis, trade wars, etc.)
]
...
I'm mostly interested in understanding historical financial markets. I've worked on company promotion, white-collar crime, the financial press, links between politicians and companies, rating agencies, brokers/dealers, market design, sovereign debt, etc. I've also done some work on networks: how and when they are useful objects and how to work with network data, and on Bayesian econometrics. Separately, I have some ongoing work on poverty relief in Britain. I like making graphs.

**Contacting me**: Feel free to email
+ Office hours (in S8.13): Monday 3-4, Tuesday 11-12. 
]
...
.large[
+ 1 $\times$ 3,500 word essay **due 5 May 2026 - 14:00!!**
    - KCL is *unrelenting* about deadlines -- must be submitted by 13:59:59 on the day!
    - I have no power to grant extensions
    - If you need an extension must submit an MCF (mitigating circumstances form -- strongly suggest you avoid!)
]
...
+ For the essay **you will come up with a question**
    ...
    - If you are stuck I am happy to suggest questions
...
+ If there are particular reasons why you cannot participate in class discussion come discuss this with me or drop me an email
